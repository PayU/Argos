...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SloSpecList) DeepCopyInto(out *SloSpecList) {
	*out = *in
	if in.Specs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SloSpecList.
func (in *SloSpecList) DeepCopy() *SloSpecList {
	if in == nil {
		return nil
	}
	out := new(SloSpecList)
